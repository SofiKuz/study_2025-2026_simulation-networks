...
Изучим содержание скрипта lab_iperf3_topo.py. В нем написан скрипт по созданию простейшей топологии из двух хостов h1 и h2, а также коммутатора s3 и контроллера c0. В начале файла видим импорт необходимых библиотек.
...
![Настройка параметров производительности](image/6.png){#fig:06 width=70%}
...
![Запуск скрипта с настройкой параметров производительности и без нее](image/71.png){#fig:071 width=70%}

![Запуск скрипта с настройкой параметров производительности и без нее](image/72.png){#fig:072 width=70%}
...
![Запуск скрипта lab_iperf3.py](image/101.png){#fig:101 width=70%}

![Запуск скрипта lab_iperf3.py](image/102.png){#fig:102 width=70%}

![Запуск скрипта lab_iperf3.py](image/103.png){#fig:103 width=70%}
...
![Проверка работы Makefile](image/121.png){#fig:121 width=70%}

![Проверка работы Makefile](image/122.png){#fig:122 width=70%}
